...
var cornerstone = require('../../../../assets/js/cornerstone-library/cornerstone.js');
 ...
 */
  ...
  var defaultConfig = {
    ...
    webWorkerPath : './assets/js/cornerstone-library/cornerstoneWADOImageLoaderWebWorker.js',
    webWorkerTaskPaths: [],
    taskConfiguration: {
      'decodeTask' : {
